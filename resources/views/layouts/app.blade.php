    ...
    <div class="min-h-screen flex">
        ...
        <aside id="sidebar-movil" class="fixed inset-y-0 left-0 z-50 w-72 bg-[#0f172a] border-r border-slate-800 text-slate-300 flex flex-col justify-between transition-transform duration-200 ease-in-out -translate-x-full lg:translate-x-0 lg:static shadow-xl">
            ...
            <div class="flex-1 flex flex-col overflow-y-auto">
                ...
                <nav class="px-4 py-2 space-y-6 text-sm">
        ...
        <div class="flex-1 flex flex-col min-w-0 bg-[#f1f5f9]">
            ...
            <header class="h-16 bg-white border-b border-slate-200 px-6 sm:px-8 flex items-center justify-between sticky top-0 z-30 shadow-2xs">
                <div class="flex items-center gap-3">
                    ...
                    <button id="boton-abrir-sidebar" type="button" class="lg:hidden p-2 rounded-xl text-slate-600 hover:text-slate-900 hover:bg-slate-100 focus:outline-none" aria-label="Abrir menú">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                ...
                <!-- Estado del usuario y ciclo escolar -->
                <div class="flex items-center gap-3">
                    <span class="inline-flex items-center gap-2 text-xs font-semibold text-slate-700 bg-slate-100/90 px-3.5 py-1.5 rounded-full border border-slate-200">
            ...
            <!-- Contenedor de la vista amplio y proporcionado -->
